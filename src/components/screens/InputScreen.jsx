      ...
      <div>
        {players() && players().map(pname =>
            <button key={pname} tabIndex={0}
              ...
              className={team === 1 ? "mr-1.5 mt-1 rounded-md border border-transparent bg-red-800 px-2 md:px-6 py-1 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:w-auto" : 
              "mr-1.5 mt-1 rounded-md border border-transparent bg-green-800 px-2 md:px-6 py-1 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:w-auto"}>
              {pname}
            </button>
        )}
      </div>
